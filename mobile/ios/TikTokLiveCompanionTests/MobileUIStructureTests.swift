...
final class MobileUIStructureTests: XCTestCase {
    ...
    func testChatSummaryMuteListAndBackgroundAudioSources() throws {
        ...
        XCTAssertTrue(plist.contains("<key>CFBundleVersion</key><string>$(CURRENT_PROJECT_VERSION)</string>"))
        XCTAssertFalse(source.contains("Direkte TikTok-Media-URLs sind temporär"))
        XCTAssertFalse(source.contains("Es werden nur Ereignistyp und Zeit erfasst"))
