# Verschluesselter Secret-Container
# Statische Auslieferung — kein Build, nur Dateien und ein schlanker Webserver.
FROM nginx:1.27-alpine

LABEL org.opencontainers.image.title="secret-vault-public"
LABEL org.opencontainers.image.description="Verschluesselter Secret-Container"
LABEL org.opencontainers.image.source="https://github.com/KikiKari/Projects"
LABEL org.opencontainers.image.licenses="MIT"

COPY secret-vault-public/ /usr/share/nginx/html/
