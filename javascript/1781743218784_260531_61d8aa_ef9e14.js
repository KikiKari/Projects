#!/usr/bin/env node
// 1781743218784_260531_61d8aa.py — portiert nach javascript
...
if (process.argv.length !== 3) {
    console.error(`Usage: ${process.argv[1]} output_file.html`);
    process.exit(1);
}
...
fs.appendFileSync(outputFile, `<html lang="de">
<head>
<meta charset="utf-8">
...
// JavaScript section
fs.appendFileSync(outputFile, `<script>
