#!/usr/bin/env node
// 1781743218784_762dc8.tcl — portiert nach javascript
// Quelle: tcl, Projects@abstractions:tcl/1781743218784_762dc8.tcl
// Erzeugt: 2026-08-18 durch ABSTRACTIONS_MANAGER.py

const fs = require('fs');

function generate_html(output_file) {
    //
...
${JSON.stringify(artifact_meta, null, 2)}
</script>
<html lang="de">
<head>
<meta charset="utf-8">
...
expBtn.onclick=()=>{ if(!VAULT)return; result.value=JSON.stringify(VAULT,null,2); };
    ...
    console.log(`HTML-Datei erfolgreich generiert: ${output_file}`);
}
