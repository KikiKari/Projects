#!/usr/bin/env node
// TikTok-Live-Viewer.html — portiert nach javascript
...
function createDocument() {
  ...
  const head = createElement('head', {}, [
    ...
    createElement('title', {}, ['TikTok Live Companion — Viewer']),
    createElement('style', {}, [`
  :root{
...
`])
  ...
  const body = createElement('body', {}, [
    createElement('div', { class: 'wrap' }, [
      createElement('header', {}, [
        createElement('h1', {}, ['TikTok Live Companion — Viewer']),
        createElement('span', { class: 'badge', id: 'badge' }, [
          createElement('span', { class: 'dot' }),
          createElement('span', { id: 'badgeText' }, ['bereit'])
        ]),
        createElement('span', { class: 'meta', id: 'checked' })
      ]),
      
      createElement('div', { class: 'row' }, [
        createElement('input', { id: 'user', placeholder: '@name eingeben — beliebiges öffentliches Konto', autofocus: '' }),
        createElement('button', { class: 'primary', id: 'go' }, ['Anzeigen']),
        createElement('button', { id: 'clear' }, ['Leeren']),
        createElement('select', { id: 'every' }, [
          createElement('option', { value: '0', selected: '' }, ['Status: nur manuell']),
          createElement('option', { value: '60' }, ['Status alle 60 s']),
          createElement('option', { value: '120' }, ['alle 2 min']),
          createElement('option', { value: '300' }, ['alle 5 min'])
        ]),
        createElement('input', { id: 'api', value: 'http://127.0.0.1:8765', placeholder: 'Monitor-Adresse', style: 'min-width:250px' })
      ]),
      
      createElement('div', { class: 'grid' }, [
        createElement('div', {}, [
          createElement('div', { class: 'player', id: 'player' }, [
            createElement('div', { class: 'ph', id: 'ph' }, [
              createElement('div', { style: 'font-size:34px' }, ['📺']),
              createElement('div', { id: 'phText' }, ['Namen eintragen und „Anzeigen“ drücken —<br>der Player startet sofort.'])
            ])
          ]),
          createElement('p', { class: 'hint' }, [
            'Eingebettet wird der offizielle TikTok-Live-Player ',
            createElement('code', { id: 'curUrl' }, ['tiktok.com/embed/live/@name']),
            ' — ',
            createElement('b', {}, ['keine Anmeldung, keine Geschenk- oder Kauf-Oberfläche']),
            '. Ist das Konto offline, zeigt der Rahmen eine Fehlerseite von TikTok; das ist das Offline-Zeichen.'
          ])
        ]),
        
        createElement('div', {}, [
          createElement('div', { class: 'card' }, [
            createElement('h2', {}, ['Aufruf']),
            createElement('div', { class: 'meta', id: 'links' }, ['noch kein Konto gewählt'])
          ]),
          
          createElement('div', { class: 'card', style: 'margin-top:12px' }, [
            createElement('h2', {}, ['Status']),
            createElement('div', { class: 'meta', id: 'status' }, [
            ...
            createElement('div', { class: 'hint' }, [
              'Monitor starten: ',
              createElement('code', {}, ['python server.py --poll-interval 120']),
              ' im Projektordner, dann oben ',
              createElement('code', {}, ['http://127.0.0.1:8765']),
              ' eintragen und „Anzeigen“ drücken.'
            ])
          ]),
          
          createElement('div', { class: 'card', style: 'margin-top:12px' }, [
            createElement('h2', {}, ['Letzte Sendungen']),
            createElement('div', { class: 'meta', id: 'streams' }, ['—'])
          ])
        ])
      ])
    ]),
...
if (require.main === module) {
  ...
  console.log(`HTML file generated: ${path.resolve(outputPath)}`);
}

module.exports = { createDocument, renderDocument };
