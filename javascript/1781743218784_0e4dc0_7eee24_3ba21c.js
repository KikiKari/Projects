#!/usr/bin/env node
// 1781743218784_0e4dc0_7eee24_3ba21c.pl — portiert nach javascript
// Quelle: perl5, Projects@abstractions:perl5/1781743218784_0e4dc0_7eee24_3ba21c.pl
...
function main(args) {
    ...
    require('fs').writeFileSync(outputFile, htmlContent, 'utf8');
