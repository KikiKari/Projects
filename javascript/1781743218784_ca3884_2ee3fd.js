#!/usr/bin/env node
// 1781743218784_ca3884.py — portiert nach javascript
...
writeFileAsync(outputFile, htmlContent, 'utf8')
    .then(() => {
        console.log(`HTML file generated: ${outputFile}`);
    })
    .catch((err) => {
        console.log(`Could not open file '${outputFile}' for writing: ${err.message}`);
        process.exit(1);
    });
