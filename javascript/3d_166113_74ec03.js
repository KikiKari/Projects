#!/usr/bin/env node
// 3d_166113.sh — portiert nach javascript
...
if (process.argv.length !== 3) {
  console.error(`Aufruf: ${process.argv[1]} <ausgabedatei.html>`);
  process.exit(1);
}
...
fs.writeFileSync(ausgabe, htmlContent);
console.error(`HTML-Datei wurde erfolgreich erstellt: ${ausgabe}`);
