#!/usr/bin/env node
// 3d_166113.py — portiert nach javascript
...
function main() {
    ...
    if (args.length !== 1) {
        console.log("Usage: node " + path.basename(process.argv[1]) + " <output_file>");
        process.exit(1);
    }
    ...
    try {
        ...
        console.log("Error writing to file " + outputFile + ": " + e.message);
        process.exit(1);
    }
}
