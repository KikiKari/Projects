#!/usr/bin/env node
// 1781743218784_260531_209208.ps1 — portiert nach javascript
...
let fp;
try {
    fp = fs.createWriteStream(outputFile, { encoding: 'utf8' });
} catch (err) {
    console.error(`Could not open file '${outputFile}' ${err.message}`);
    process.exit(1);
}
