#!/usr/bin/env node
// 1781743218784_260531_209208.py — portiert nach javascript
...
if (process.argv.length !== 3) {
    console.log("Usage: tclsh [info script] output_file.html");
    process.exit(1);
}
...
let fp;
try {
    fp = fs.createWriteStream(outputFile);
} catch (e) {
    console.log(`Could not open file '${outputFile}' ${e}`);
    process.exit(1);
}
