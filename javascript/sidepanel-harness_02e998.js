...
// Erzeuge den HTML-Inhalt dynamisch
function generateHTML() {
  const now = new Date().toISOString();
  
  const state = {
    page: { url: "https://www.tiktok.com/@demo/live", title: "Demo LIVE", scannedAtUtc: now },
    ...
    chatMessages: [
      { messageId: "1", participantKey: "id:1", author: "Anna", content: "Guten Abend", contentLanguage: "de-DE", source: "websocket", receivedAtUtc: now },
      { messageId: "2", participantKey: "id:2", author: "Ben", content: "Welche Sorte ist das?", contentLanguage: "de-DE", source: "dom", receivedAtUtc: now },
      { messageId: "3", author: "Clara", content: "Danke für die Erklärung", contentLanguage: "de-DE", source: "websocket", receivedAtUtc: now },
      { messageId: "4", author: "David", content: "Bitte einmal mischen", contentLanguage: "de-DE", source: "websocket", receivedAtUtc: now },
      { messageId: "5", author: "Eva", content: "Das ist gut lesbar", contentLanguage: "de-DE", source: "websocket", receivedAtUtc: now }
    ],
    participants: {
      "id:1": { key: "id:1", name: "Anna", messageCount: 12, wordCount: 48, giftEventCount: 2, giftItemCount: 24, lastSeenAtUtc: now },
      "id:2": { key: "id:2", name: "Ben", messageCount: 8, wordCount: 39, giftEventCount: 0, giftItemCount: 0, lastSeenAtUtc: now },
      "name:clara": { key: "name:clara", name: "Clara", messageCount: 6, wordCount: 31, giftEventCount: 1, giftItemCount: 1, lastSeenAtUtc: now }
    },
    streamMutes: [],
    ...
    captions: [
      { receivedAtUtc: now, sentenceId: "42", definite: true, contents: [{ lang: "de", text: "Dies ist eine Test-Caption." }] }
    ],
    debug: { enabled: false, entries: [{ atUtc: now, event: "scan", detail: { mediaCount: 3 } }] }
  };
...
// Hauptfunktion
function main() {
  const outputPath = process.argv[2] || 'sidepanel-harness.html';
