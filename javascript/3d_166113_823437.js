#!/usr/bin/env node
// 3d_166113.tcl — portiert nach javascript
// Quelle: tcl, Projects@abstractions:tcl/3d_166113.tcl
// Erzeugt: 2026-08-08 durch ABSTRACTIONS_MANAGER.py

const fs = require('fs');

function write_3d_html(filename) {
    const html = generate_html_content();
...
if (process.argv.length !== 3) {
    console.log("Verwendung: " + process.argv[1] + " <ausgabedatei>");
    process.exit(1);
}

const output_file = process.argv[2];
write_3d_html(output_file);
console.log("HTML-Datei wurde erfolgreich erstellt: " + output_file);
