#!/usr/bin/env node
// 1781743218784_0e4dc0_7eee24.sh — portiert nach javascript
// Quelle: shell, Projects@abstractions:shell/1781743218784_0e4dc0_7eee24.sh
// Erzeugt: 2026-08-23 durch ABSTRACTIONS_MANAGER.py

// 1781743218784_0e4dc0.py — portiert nach shell — portiert nach JavaScript
...
if (process.argv.length !== 3) {
    console.error(`Aufruf: node ${process.argv[1]} <Ausgabedatei>`);
    process.exit(1);
}
...
console.log(`HTML-Datei erzeugt: ${outputFile}`);
