#!/usr/bin/env node
// 1781743218784_260531_61d8aa.ps1 — portiert nach javascript
...
if (process.argv.length !== 3) {
    console.error(`Usage: ${path.basename(process.argv[1])} output_file.html`);
    process.exit(1);
}
...
const doctypeAndMeta = `<!DOCTYPE html>
...
fs.writeFileSync(outputFile, doctypeAndMeta, 'utf8');

// Write HTML start and head section
const htmlHead = `<html lang="de">
<head>
<meta charset="utf-8">
...
fs.appendFileSync(outputFile, htmlHead, 'utf8');
...
fs.appendFileSync(outputFile, htmlBody, 'utf8');

// JavaScript section
const javascriptSection = `<script>
...
fs.appendFileSync(outputFile, javascriptSection, 'utf8');
...
fs.appendFileSync(outputFile, closeHtml, 'utf8');
