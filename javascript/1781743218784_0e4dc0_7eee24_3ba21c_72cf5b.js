#!/usr/bin/env node
// 1781743218784_0e4dc0_7eee24_3ba21c.py — portiert nach javascript
...
program
    .description('Generate HTML file for Secret-Vault Public')
    .argument('<output_file>', 'Output HTML file path')
    .action((outputFile) => {
