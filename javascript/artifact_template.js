#!/usr/bin/env node
// artifact_template.html — portiert nach javascript
              ...
              children: [
                {
                  input: {
                    id: 'addName',
                    placeholder: '@name eines öffentlichen Kanals',
              ...
              children: [
                ...
                },
                {
                  p: {
                    ...
                    text: 'Diese Ansicht fragt jeden beobachteten Kanal im eingestellten Turnus selbst ab. Zwei Wege, automatisch in dieser Reihenfolge:'
                  }
                },
                {
                  ol: {
                    ...
                    children: [
                      {
                        li: {
                          children: [
                            ...
                            ' (bevorzugt) — führt ',
                            {
                              code: 'cli.py --json live <kanal> --once'
                            },
                            ' im Projektordner aus. Liefert exakte Zeitstempel, Aufrufzahlen und einen dauerhaften Verlauf auf der Festplatte.'
                          ]
                        }
                      },
                      {
                        li: {
                          children: [
                            {
                              b: 'Direktabruf der Web-Vorschau'
                            },
                            ' — liest ',
                            {
                              code: 't.me/s/<kanal>'
                            },
                            ' und wertet den Text aus. Funktioniert ohne das lokale Werkzeug, kennt aber nur die Uhrzeit, nicht das Datum eines Beitrags.'
                          ]
                        }
                      }
                    ]
                ...
                },
                {
                  p: {
                    class: 'sub',
                    text: 'Der gesammelte Verlauf bleibt in dieser Ansicht gespeichert und wächst mit jedem Durchlauf. Neue Beiträge werden grün markiert. Für Dauerbetrieb im Hintergrund: ',
                    ...
                    children: [
                      {
                        button: {
                          id: 'reset',
                          text: 'Verlauf in dieser Ansicht löschen'
                        }
                      }
                    ]
                  }
