...
> Plattformbranch `TikTok-Live-Companion-Android`: enthält die native Kotlin-/Compose-/AndroidX-WebKit-App für Android und HyperOS. Der iOS-Quellstand liegt im Branch `TikTok-Live-Companion-iOS`.
