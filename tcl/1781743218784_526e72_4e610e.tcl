#!/usr/bin/env tclsh
# 1781743218784_526e72.ps1 — portiert nach tcl
# Quelle: powershell, Projects@abstractions:powershell/1781743218784_526e72.ps1
# Erzeugt: 2026-08-21 durch ABSTRACTIONS_MANAGER.py

# 1781743218784_526e72.tcl — portiert nach tcl
# Quelle: powershell, Projects@abstractions:powershell/1781743218784_526e72.ps1
...
if {[catch {set fd [open $OutputPath w]} error]} {
    puts stderr "Could not open file '$OutputPath' for writing: $error"
    exit 1
}

if {[catch {puts -nonewline $fd $htmlContent; close $fd} error]} {
    puts stderr "Could not write to file '$OutputPath': $error"
    exit 1
}
