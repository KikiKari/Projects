...
# Tcl/Tk port of the 3D visualization HTML page
# This script generates the HTML file and launches a browser to view it

package require Tcl 8.6

# Configuration
set output_file "3d_visualization.html"

# HTML content as a Tcl string
set html_content {
<!DOCTYPE html>
<html lang="de">
<head>
...
puts $fh $html_content
close $fh

# Try to open in browser
if {[catch {exec xdg-open $output_file}]} {
    if {[catch {exec open $output_file}]} {
        if {[catch {exec start $output_file}]} {
            puts "Generated $output_file - please open it in your browser"
        }
    }
}
