...
# 1781743218784_762dc8.ps1 — portiert nach tcl
...
# EXAMPLE
# tclsh script.tcl ./vault.html

if {$argc != 1} {
    puts stderr "Usage: [info script] <OutputFile>"
    exit 1
}
...
expBtn.onclick=()=>{ if(!VAULT)return; result.value=JSON.stringify(VAULT,null,2); };
    ...
    close $fh
    puts "HTML-Datei erfolgreich generiert: $outputFile"
}
