...
# Tcl/Tk port of OnboardingandProjects_canvablock.html
# This script generates the HTML document dynamically

package require Tk

# Create the main window
wm title . "Onboarding and Projects"

# Create a text widget to hold our HTML content
text .html -wrap none -state disabled
pack .html -fill both -expand 1

# Procedure to generate the complete HTML document
proc generateHTML {} {
    set htmlContent {
<!DOCTYPE html>
<html>
