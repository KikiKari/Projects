...
# 1781743218784_762dc8.sh — portiert nach tcl
...
<script type="application/json" id="cowork-artifact-meta">
    ...
    append html_content $artifact_meta
...
expBtn.onclick=()=>{ if(!VAULT)return; result.value=JSON.stringify(VAULT,null,2); };
    ...
    puts "HTML-Datei erfolgreich generiert: $output_file"
}

proc main {argv} {
    if {[llength $argv] != 1} {
        puts "Verwendung: [info script] <ausgabedatei.html>"
        exit 1
    }
