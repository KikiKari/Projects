#!/usr/bin/env tclsh
# 1781743218784_260531_61d8aa.py — portiert nach tcl
...
# Schreibe DOCTYPE und main script tag
set f [open $output_file w]
puts -nonewline $f {<!DOCTYPE html>
...
# Schreibe HTML Start und head section
set f [open $output_file a]
puts -nonewline $f {<html lang="de">
<head>
<meta charset="utf-8">
