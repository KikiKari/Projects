#!/usr/bin/env tclsh
# vision-check.html — portiert nach tcl
...
# Tcl/Tk port of vision-check.html
# This script generates the complete HTML file when executed with a filename argument
