#!/usr/bin/tclsh
# 3d_44b946.pl — portiert nach tcl
...
if {$argc != 1} {
    puts stderr "Bitte gib eine Ausgabedatei als Parameter an."
    exit 1
}
set ausgabedatei [lindex $argv 0]
...
# In Datei schreiben
set fh [open $ausgabedatei w]
puts -nonewline $fh $html
close $fh

puts "HTML-Datei wurde erfolgreich in '$ausgabedatei' gespeichert."
