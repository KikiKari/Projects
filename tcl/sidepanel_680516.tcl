...
# Tcl 8.6 script to generate sidepanel.css
# Usage: tclsh sidepanel.tcl <output_file>
...
@media (prefers-reduced-motion: reduce) { * { scroll-behavior: auto !important; } }
    ...
    # Remove leading newline and trailing spaces
    set css_content [string trim $css_content]
    return $css_content
}
