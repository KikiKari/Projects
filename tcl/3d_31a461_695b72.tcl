#!/usr/bin/env tclsh
# 3d_31a461.sh — portiert nach tcl
...
set ausgabe [lindex $argv 0]

# HTML-Dokument generieren
set fp [open $ausgabe w]
...
puts "HTML-Dokument wurde in '$ausgabe' erzeugt."
