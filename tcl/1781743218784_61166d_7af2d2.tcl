#!/usr/bin/env tclsh
# 1781743218784_61166d.ps1 — portiert nach tcl
# Quelle: powershell, Projects@abstractions:powershell/1781743218784_61166d.ps1
...
proc Main {OutputFile} {
    ...
    if { [catch {
        ...
        if { [file exists $OutputFile] } {
            ...
            error "Fehler beim Erstellen der HTML-Datei"
        }
    } err] } {
        puts stderr "Fehler beim Erstellen der HTML-Datei: $err"
        exit 1
    }
}
