#!/usr/bin/env tclsh
# 1781743218784_260531_209208.sh — portiert nach tcl
# Quelle: shell, Projects@abstractions:shell/1781743218784_260531_209208.sh
...
puts $fp {      <div class="row" style="margin-top:6px"><input class="nf" data-np="\${esc(name)}" placeholder="\${tr("newField")}" style="max-width:180px"><input class="nv" data-np="\${esc(name)}" placeholder="\${tr("newValue")}" style="max-width:260px"><button class="btn sm" data-addf="\${esc(name)}">\${tr("addField")}</button></div>`;}
