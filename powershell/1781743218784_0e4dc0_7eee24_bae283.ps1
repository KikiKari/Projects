#!/usr/bin/env pwsh
# 1781743218784_0e4dc0_7eee24.sh — portiert nach powershell
# Quelle: shell, Projects@abstractions:shell/1781743218784_0e4dc0_7eee24.sh
# Erzeugt: 2026-08-23 durch ABSTRACTIONS_MANAGER.py

# Prüfe Anzahl Argumente
if ($args.Count -ne 1) {
    Write-Error "Aufruf: $($MyInvocation.MyCommand.Name) <Ausgabedatei>"
    exit 1
}
...
Write-Host "HTML-Datei erzeugt: $outputFile"
