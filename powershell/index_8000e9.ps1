...
<#
.SYNOPSIS
    Generates an HTML document for comparing hover-preview variants.
.DESCRIPTION
    This script generates the HTML content for a comparison of three hover-preview variants
    and writes it to a specified output file.
.PARAMETER OutputFile
    The path to the output HTML file.
.EXAMPLE
    .\generate-hover-preview.ps1 -OutputFile "index.html"
#>
...
Write-Output "HTML file generated successfully at $OutputFile"
