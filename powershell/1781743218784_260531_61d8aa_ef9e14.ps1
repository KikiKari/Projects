#!/usr/bin/env pwsh
# 1781743218784_260531_61d8aa.py — portiert nach powershell
# Quelle: python, Projects@abstractions:python/1781743218784_260531_61d8aa.py
...
'@
    ...
    Set-Content -Path $OutputFile -Value $doctypeAndMeta -Encoding UTF8
...
'@
    ...
    Add-Content -Path $OutputFile -Value $htmlHead -Encoding UTF8
...
'@
    ...
    Add-Content -Path $OutputFile -Value $bodyContent -Encoding UTF8
...
'@
    ...
    Add-Content -Path $OutputFile -Value $javascriptSection -Encoding UTF8
...
'@
    ...
    Add-Content -Path $OutputFile -Value $closeHtml -Encoding UTF8
