#!/usr/bin/env pwsh
# 3d_166113.sh — portiert nach powershell
# Quelle: shell, Projects@abstractions:shell/3d_166113.sh
# Erzeugt: 2026-08-08 durch ABSTRACTIONS_MANAGER.py

# Parameter: Ausgabedatei
if ($args.Count -ne 1) {
  Write-Error "Aufruf: $($MyInvocation.MyCommand.Name) <ausgabedatei.html>"
  exit 1
}
$ausgabe = $args[0]
...
$htmlContent | Out-File -FilePath $ausgabe -Encoding utf8

Write-Host "HTML-Datei wurde erfolgreich erstellt: $ausgabe" -ForegroundColor Green
