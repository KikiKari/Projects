...
<#
.SYNOPSIS
Generates the Raku Documentation index.html file.
.DESCRIPTION
This script generates the complete HTML structure for the Raku Documentation website index page,
replicating all elements from the original HTML file including head section, navigation bar,
main content sections, cards, links block and footer.
...
<head>
    ...
    <script src="/assets/scripts/tableManager.js"></script>
    <script src="/assets/scripts/filter-script.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/fuzzysort@2.0.4/fuzzysort.min.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/@tarekraafat/autocomplete.js@10.2.7/dist/autoComplete.min.js"></script>
    <script src="/assets/scripts/filtered-toc.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.9.0/highlight.min.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.9.0/languages/haskell.min.js"></script>
    <script src="/assets/scripts/options-search.js"></script>
    <script src="/assets/scripts/page-styling.js"></script>
    <script src="/assets/scripts/rainbow.js"></script>
</head>
    ...
    <div class="container is-justify-content-space-around">
        ...
        <div id="navMenu" class="navbar-menu">
            <div class="navbar-start">
                <a class="navbar-item" href="/introduction" title="Getting started, Tutorials, Migration guides">Introduction</a>
                <a class="navbar-item" href="/reference" title="Fundamentals, General reference">Reference</a>
                <a class="navbar-item" href="/miscellaneous" title="Programs, Experimental">Miscellaneous</a>
                <a class="navbar-item" href="/types" title="The core types (classes) available">Types</a>
                <a class="navbar-item" href="/routines" title="Searchable table of routines">Routines</a>
                <a class="navbar-item" href="https://raku.org" title="Home page for community">Raku<sup>®</sup></a>
                <a class="navbar-item" href="https://web.libera.chat/#raku" title="IRC live chat">Chat</a>
                <div class="navbar-item has-dropdown is-hoverable">
                    <a class="navbar-link">More</a>
                    <div class="navbar-dropdown is-right is-rounded">
                        <hr class="navbar-divider">
                        <a class="navbar-item js-modal-trigger" data-target="download-ebook">Download E-Book (epub)</a>
                        <hr class="navbar-divider">
                        <a class="navbar-item" href="/about">About</a>
                        <hr class="navbar-divider">
                        <a class="navbar-item has-text-red" href="https://github.com/raku/doc-website/issues">Report an issue with this site</a>
                        <hr class="navbar-divider">
                        <a class="navbar-item" href="https://github.com/raku/doc/issues">Report an issue with the documentation content</a>
                    </div>
                </div>
            </div>
                ...
                <div class="modal-content">
                    <div class="box">
                        ...
                        <div class="control is-grouped is-grouped-centered options-search-controls">
                            ...
                            <p>The search engine can perform a strict search (only the characters in the search box) or a loose search (Alt-L)</p>
                            ...
                            <p>Search in the names of composite pages, which combine similar information from the main web pages (Alt-C)</p>
                            ...
                            <p>Once a search candidate has been chosen, it can be opened in a new tab or in the current tab (Alt-Q)</p>
        ...
        <div id="download-ebook" class="modal">
            ...
            <div class="modal-content">
                <div class="box">
                    <p><a href="/RakuDocumentation.epub" download>RakuDocumentation.epub</a> is a work in progress e-book. It targets the <a href="https://www.w3.org/publishing/epub3/">EPUB v3 specification</a>. It needs testing on a variety of ereaders (some of which may still implicitly expect compliance with EPUB v2). The CSS definitely needs enhancing (especially for code snippets). The Ebook opens in a Calibre reader, which is available on all operating systems.</p>
                    <p>Suggestions are welcome and should be addressed by opening an issue on the Raku/doc-website repository</p>
...
<div id="wrapper">
    <section class="hero is-medium is-primary">
        <div class="hero-body">
            <div class="container">
                <h1 class="title is-1 is-size-2-mobile has-text-centered">Raku documentation</h1>
                <h2 class="subtitle is-4 has-text-centered mt-3">Welcome to the official documentation of the Raku<sup>®</sup> programming language!</h2>
            </div>
        </div>
    </section>
                ...
                <div class="column is-one-half">
                    <div class="card card-home">
                        <div class="card-content">
                            ...
                            <div class="content has-text-centered">Documents introducing the language for various audiences.</div>
                            <div class="has-text-centered">
                                <a class="button is-primary" href="/introduction"><strong>Learn more</strong></a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="column is-one-half">
                    <div class="card card-home">
                        <div class="card-content">
                            ...
                            <div class="content has-text-centered">Documents explaining the various conceptual parts of the language.</div>
                            <div class="has-text-centered">
                                <a class="button is-primary" href="/reference"><strong>Learn more</strong></a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="column is-one-third">
                    <div class="card card-home">
                        <div class="card-content">
                            ...
                            <div class="content has-text-centered">Index of built-in classes, roles and enums.</div>
                            <div class="has-text-centered">
                                <a class="button is-primary" href="/types"><strong>Learn more</strong></a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="column is-one-third">
                    <div class="card card-home">
                        <div class="card-content">
                            ...
                            <div class="content has-text-centered">Index of built-in subroutines and methods.</div>
                            <div class="has-text-centered">
                                <a class="button is-primary" href="/routines"><strong>Learn more</strong></a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="column is-one-third">
                    <div class="card card-home">
                        <div class="card-content">
                            ...
                            <div class="content has-text-centered">Documents explaining experimental topics and Raku programs rather than the language itself.</div>
                            <div class="has-text-centered">
                                <a class="button is-primary" href="/miscellaneous"><strong>Learn more</strong></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card card-home">
                        <div class="card-content">
                            <div class="has-text-centered">
                                <a href="/language/faq">
                                    <span class="icon is-large has-text-primary">
                                        <svg class="svg-inline--fa fa-question-circle fa-w-16 icon-large" aria-hidden="true" data-prefix="fas" data-icon="question-circle" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="">
                            ...
                            <div class="content has-text-centered">A collection of questions that have cropped up often, along with answers.</div>
                            <div class="has-text-centered">
                                <a class="button is-primary" href="/language/faq"><strong>Learn more</strong></a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-content">
                            <div class="has-text-centered">
                                <a href="/language/community">
                                    <span class="icon is-large has-text-primary">
                                        <svg class="svg-inline--fa fa-user-friends fa-w-20 icon-large" aria-hidden="true" data-prefix="fas" data-icon="user-friends" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" data-fa-i2svg="">
                            ...
                            <div class="content has-text-centered">Information about the Raku development community, email lists, IRC and IRC bots, and blogs.</div>
                            <div class="has-text-centered">
                                <a class="button is-primary" href="/language/community"><strong>Learn more</strong></a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="raku links-block">
        <div class="container px-4 py-5">
            <div class="columns is-vcentered">
                <div class="column is-one-third has-text-centered">
                    <div class="pt-5">
                        <span class="icon is-large">
                            <svg class="svg-inline--fa fa-hashtag fa-w-14 icon-large" aria-hidden="true" data-prefix="fas" data-icon="hashtag" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg="">
    ...
    <div class="container px-4">
        <nav class="level">
            <div class="level-left">
                ...
                <div class="level-item"><a id="toggle-theme">Toggle theme</a></div>
                <div class="level-item" title="0ead45c 2026-04-04"><a>Commit</a></div>
            </div>
            <div class="level-right">
                <div class="level-item"><a href="/license">License</a></div>
            </div>
        </nav>
    </div>
</footer>
