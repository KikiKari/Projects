#!/usr/bin/env pwsh
# viewer.html — portiert nach powershell
# Quelle: html, Projects@Telegram-Monitor:plugin/extension/viewer.html
# Erzeugt: 2026-08-19 durch ABSTRACTIONS_MANAGER.py

<#
.SYNOPSIS
Generates an HTML file for the TikTok Live Viewer application.
.DESCRIPTION
This script creates a self-contained HTML file that allows users to view TikTok Live streams
and optionally monitor stream status via a local API endpoint.
.PARAMETER OutputPath
The path where the generated HTML file will be saved.
.EXAMPLE
.\viewer.ps1 -OutputPath "C:\temp\tiktok-viewer.html"
#>
...
<div class="wrap">
  ...
  <div class="row">
    ...
    <input id="api" placeholder="Monitor, z. B. http://127.0.0.1:8765 (optional)" style="min-width:270px">
  </div>
