#!/usr/bin/env pwsh
# 3d_31a461.py — portiert nach powershell
# Quelle: python, Projects@abstractions:python/3d_31a461.py
...
function ConvertTo-JsonLite($obj) {
    # Custom function to create JSON without extra whitespace like Python's separators=(',', ':')
...
function Generate-Html {
    ...
    $specJson = ConvertTo-JsonLite $SPEC
