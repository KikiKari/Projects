#!/usr/bin/env pwsh
# firstscript.html — portiert nach powershell
...
<html lang="en" data-content_root="../">
  ...
  <body>
    <div class="header-wrapper" role="banner">
      <div class="header">
        <div class="headertitle"><a href="../index.html">Eggdrop 1.10.1rc2 documentation</a></div>
        <div class="rel" role="navigation" aria-label="related navigation">
          <a href="userfilesharing.html" title="Sharing Userfiles" accesskey="P">previous</a> |
          <a href="module.html" title="Writing a Basic Eggdrop Module" accesskey="N">next</a>
        </div>
      </div>
    </div>
            ...
            <div class="bodywrapper">
              <div class="body" role="main">
                <section id="writing-an-eggdrop-tcl-script">
                  ...
                  <p>So you want to write an Eggdrop Tcl script, but you don't really know where to begin. This file will give you a very basic idea about what Eggdrop scripting is like, using a <em>very</em> simple script that may help you get started with your own scripts.</p>
                  <p>This guide assumes you know a bit about Eggdrops and IRC. You should have already installed Eggdrop. The bot should not be on any important or busy channels (development bots can be annoying if your script has bugs). If you plan on doing a lot of development, enable the .tcl and .set commands, and make sure nobody else has access to your bot. The .tcl and .set commands are helpful in debugging and testing your code.</p>
                  <p>First, read through the script. Very few commands are listed here intentionally, but as you want to develop more advanced scripts, you will definitely want to get familiar with the <a class="reference external" href="https://www.tcl.tk/man/tcl8.6/TclCmd/contents.htm">core Tcl language commands</a>, especially the string- and list-related commands, as well as Eggdrop's own library of custom Tcl commands, located in <a class="reference external" href="https://docs.eggheads.org/using/tcl-commands.html">tcl-commands.doc</a></p>
                  <p>If you have the .tcl command enabled, you can load a script by typing '.tcl source script/file.tcl' to load it. Otherwise, add it to your config file like normal (examples to do so are at the bottom of the config file) and '.rehash' or '.restart' your bot.</p>
                  <p>Let's look at a very basic example script that greets users as they join a channel:</p>
                  <div class="highlight-default notranslate">
                    <div class="highlight">
                      <pre><span></span># GreetScript.tcl
# Version: 1.0
...
putlog "greetscript.tcl v1.0 by Geo"</pre>
                    </div>
                  </div>
                  ...
                  <div class="highlight-default notranslate">
                    <div class="highlight">
                      <pre><span></span><span class="c1"># GreetScript.tcl</span>
<span class="c1"># Version: 1.0</span>
<span class="c1"># Author: Geo &lt;geo@eggheads.org&gt; or #eggdrop on Libera</span>
<span class="c1">#</span>
<span class="c1"># Description:</span>
<span class="c1"># A simple script that greets users as they join a channel</span></pre>
                    </div>
                  </div>
                  ...
                  <div class="highlight-default notranslate">
                    <div class="highlight">
                      <pre><span></span><span class="c1">### Config Section ###</span>
...
<span class="c1">### DO NOT EDIT BELOW HERE UNLESS YOU KNOW WHAT YOU ARE DOING! ###</span></pre>
                    </div>
                  </div>
                  ...
                  <div class="highlight-default notranslate">
                    <div class="highlight">
                      <pre><span></span><span class="n">bind</span> <span class="n">join</span> <span class="o">-</span> <span class="o">*</span> <span class="n">greet</span></pre>
                    </div>
                  </div>
                  ...
                  <table class="docutils align-default">
                    <thead>
                      <tr class="row-odd">
                        <th class="head" colspan="2"><p>bind JOIN</p></th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr class="row-even">
                        <td colspan="2"><p>bind join &lt;flags&gt; &lt;mask&gt; &lt;proc&gt;</p></td>
                      </tr>
                      <tr class="row-odd">
                        <td colspan="2"><p>procname &lt;nick&gt; &lt;<a class="reference external" href="mailto:user&#37;&#52;&#48;host">user<span>&#64;</span>host</a>&gt; &lt;handle&gt; &lt;channel&gt;</p></td>
                      </tr>
                      <tr class="row-even">
                        <td colspan="2"><p>Description: triggered by someone joining the channel. The mask in the bind is matched against "#channel <a class="reference external" href="mailto:nick!user&#37;&#52;&#48;host">nick!user<span>&#64;</span>host</a>" and can contain wildcards.</p></td>
                      </tr>
                    </tbody>
                  </table>
                  ...
                  <div class="highlight-default notranslate">
                    <div class="highlight">
                      <pre><span></span><span class="n">proc</span> <span class="n">greet</span> <span class="p">{</span><span class="n">nick</span> <span class="n">uhost</span> <span class="n">hand</span> <span class="n">chan</span><span class="p">}</span> <span class="p">{</span></pre>
                    </div>
                  </div>
                  ...
                  <div class="highlight-default notranslate">
                    <div class="highlight">
                      <pre><span></span><span class="k">global</span> <span class="n">pmsg</span>
<span class="k">global</span> <span class="n">greetmsg</span></pre>
                    </div>
                  </div>
                  ...
                  <div class="highlight-default notranslate">
                    <div class="highlight">
                      <pre><span></span><span class="k">if</span> <span class="p">{</span><span class="n">pmsg</span><span class="p">}</span> <span class="p">{</span>
...
<span class="p">}</span></pre>
                  ...
                  <div class="highlight-default notranslate">
                    <div class="highlight">
                      <pre><span></span><span class="n">putlog</span> <span class="s2">"greetscript.tcl v1.0 by Geo"</span></pre>
                    </div>
                  </div>
      ...
      <div class="footer">
        <div class="left">
          <div role="navigation" aria-label="related navigaton">
            <a href="userfilesharing.html" title="Sharing Userfiles">previous</a> |
            <a href="module.html" title="Writing a Basic Eggdrop Module">next</a>
          </div>
          <div role="note" aria-label="source link"></div>
        </div>
        <div class="right">
          <div class="footer" role="contentinfo">
            &#169; Copyright 2025, Eggheads. Last updated on Aug 15, 2025. Created using <a href="https://www.sphinx-doc.org/">Sphinx</a> 8.2.3.
          </div>
        </div>
        <div class="clearer"></div>
      </div>
