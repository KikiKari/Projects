#!/usr/bin/env pwsh
# 1781743218784_231ad7.sh — portiert nach powershell
# Quelle: shell, Projects@abstractions:shell/1781743218784_231ad7.sh
...
secret vault using WebCrypto APIs. The output file contains all necessary HTML,
CSS, and JavaScript code for the application to run in a browser.

.PARAMETER OutputFile
The path where the generated HTML file will be saved.

.EXAMPLE
pwsh script.ps1 -OutputFile "vault.html"
#>
...
try {
    ...
    if (Test-Path $OutputFile) {
        ...
        Write-Error "Error generating HTML file"
        exit 1
    }
} catch {
