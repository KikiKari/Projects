...
<#
.SYNOPSIS
    Generates the sidepanel.html file from PowerShell 7 code structure.
.DESCRIPTION
    This script programmatically constructs the HTML document representing the
    TikTok LIVE Companion side panel interface and writes it to a specified output file.
