#!/usr/bin/env pwsh
# 1781743218784_762dc8.tcl — portiert nach powershell
# Quelle: tcl, Projects@abstractions:tcl/1781743218784_762dc8.tcl
...
.DESCRIPTION
Dieses Skript generiert eine vollständige HTML-Datei für das Secret-Vault Public Tool.
Es erstellt eine eigenständige HTML-Datei mit allen benötigten Ressourcen inline.
...
$($artifact_meta | ConvertTo-Json -Depth 10)
</script>
<html lang="de">
<head>
<meta charset="utf-8">
...
$html_content | Out-File -FilePath $OutputFile -Encoding utf8
