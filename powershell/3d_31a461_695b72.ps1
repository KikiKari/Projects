#!/usr/bin/env pwsh
# 3d_31a461.sh — portiert nach powershell
...
# Kombiniere alle Teile und schreibe in die Ausgabedatei
$htmlHead + $jsonData + $htmlScript | Out-File -FilePath $ausgabe -Encoding UTF8

Write-Output "HTML-Dokument wurde in '$ausgabe' erzeugt."
