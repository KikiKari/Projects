...
# Create the HTML content using PowerShell's here-string and variable substitution
$htmlContent = @"
<!DOCTYPE html>
...
<body>
<div class="wrap">
  <div class="brand"><div class="mark"></div><h1 id="title">Vault Cache</h1></div>
