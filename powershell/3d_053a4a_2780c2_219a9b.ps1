#!/usr/bin/env pwsh
# 3d_053a4a_2780c2.pl — portiert nach powershell
...
function Generate-Html {
    ...
    $html += '<title>Python Hardener — Interaktive Architektur</title>'
    $html += '<meta name="description" content="Der Messplatz: zwei Läufe, dieselben Behauptungen, ein Ergebnis — drehen, zoomen, Knoten auswählen.">'
    $html += '<meta name="theme-color" content="#b45309">'
...
"@
    ...
    $html += '<h1>Python Hardener</h1>'
    $html += '<p class="lede">Der Messplatz: zwei Läufe, dieselben Behauptungen, ein Ergebnis — drehen, zoomen, Knoten auswählen.</p>'
    ...
    $html += '<dl class="feld"><dt>Schicht</dt><dd id="k-schicht">—</dd></dl>'
    $html += '<dl class="feld"><dt>ID</dt><dd id="k-id">—</dd></dl>'
