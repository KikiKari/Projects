...
# Create DOCTYPE (will be handled during output)
# Create root html element with lang attribute
$html = $doc.CreateElement("html")
$html.SetAttribute("lang", "de")
$doc.AppendChild($html) | Out-Null

# Create head section
$head = $doc.CreateElement("head")
$html.AppendChild($head) | Out-Null
...
$metaDescription.SetAttribute("content", "Lokaler Regen-Check für die nächsten 30, 60 und 120 Minuten")
$head.AppendChild($metaDescription) | Out-Null

$metaAppleCapable = $doc.CreateElement("meta")
$metaAppleCapable.SetAttribute("name", "apple-mobile-web-app-capable")
$metaAppleCapable.SetAttribute("content", "yes")
$head.AppendChild($metaAppleCapable) | Out-Null

$metaAppleStatusBar = $doc.CreateElement("meta")
...
$head.AppendChild($metaAppleStatusBar) | Out-Null

$metaAppleTitle = $doc.CreateElement("meta")
$metaAppleTitle.SetAttribute("name", "apple-mobile-web-app-title")
$metaAppleTitle.SetAttribute("content", "Weather")
$head.AppendChild($metaAppleTitle) | Out-Null

# Add link tags
$linkManifest = $doc.CreateElement("link")
$linkManifest.SetAttribute("rel", "manifest")
$linkManifest.SetAttribute("href", "./manifest.json")
$head.AppendChild($linkManifest) | Out-Null

$linkIcon = $doc.CreateElement("link")
$linkIcon.SetAttribute("rel", "apple-touch-icon")
$linkIcon.SetAttribute("href", "./icon-512.png")
$head.AppendChild($linkIcon) | Out-Null

# Add title
$title = $doc.CreateElement("title")
$title.InnerText = "Weather - Regen-Check"
$head.AppendChild($title) | Out-Null

# Add script and stylesheet links
$scriptModule = $doc.CreateElement("script")
$scriptModule.SetAttribute("type", "module")
$scriptModule.SetAttribute("crossorigin", "")
$scriptModule.SetAttribute("src", "./assets/index-DGdzG44S.js")
$head.AppendChild($scriptModule) | Out-Null

$linkStylesheet = $doc.CreateElement("link")
$linkStylesheet.SetAttribute("rel", "stylesheet")
$linkStylesheet.SetAttribute("crossorigin", "")
$linkStylesheet.SetAttribute("href", "./assets/index-erFv57XC.css")
$head.AppendChild($linkStylesheet) | Out-Null

# Create body section
$body = $doc.CreateElement("body")
$html.AppendChild($body) | Out-Null

# Add root div
$rootDiv = $doc.CreateElement("div")
$rootDiv.SetAttribute("id", "root")
$body.AppendChild($rootDiv) | Out-Null

# Add script with complex JavaScript content
$scriptElement = $doc.CreateElement("script")
$scriptElement.SetAttribute("data-pplx-inline-edit", "")
...
'@
$body.AppendChild($scriptElement) | Out-Null
