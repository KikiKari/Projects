...
<#
.SYNOPSIS
Generates the Tagesstatus Live Public HTML page.

.DESCRIPTION
This script generates an HTML file that displays live status information from various services.
It creates a self-contained HTML page with embedded CSS and JavaScript that can be opened in a browser.

.PARAMETER OutputPath
The path where the generated HTML file should be saved.

.EXAMPLE
./Generate-TagesstatusLive.ps1 -OutputPath "C:\temp\index.html"
#>
...
.kv .k { color:#6b6a66; } .kv .v { font-weight:600; }
a { color:#2b5cc4; text-decoration:none; } a:hover { text-decoration:underline; }
/* settings modal */
...
Write-Host "Tagesstatus Live Public HTML page generated at: $OutputPath"
