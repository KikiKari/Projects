#!/usr/bin/env pwsh
# 3d.sh — portiert nach powershell
# Quelle: shell, Projects@abstractions:shell/3d.sh
...
Set-Content -Path $Ausgabedatei -Value $HtmlInhalt -Encoding Utf8

Write-Output "HTML-Dokument wurde erfolgreich in '$Ausgabedatei' geschrieben."
