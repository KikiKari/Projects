...
<#
.SYNOPSIS
    Generates the sidepanel.css file.
.DESCRIPTION
    This script generates the sidepanel.css file with the specified styles.
.PARAMETER OutputPath
    The path to the output CSS file.
.EXAMPLE
    .\Generate-SidePanelCss.ps1 -OutputPath "sidepanel.css"
#>
...
# Define CSS content as here-string
$cssContent = @'
:root {
