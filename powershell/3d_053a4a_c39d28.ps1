#!/usr/bin/env pwsh
# 3d_053a4a.sh — portiert nach powershell
# Quelle: shell, Projects@abstractions:shell/3d_053a4a.sh
...
'@ | Out-File -FilePath $ausgabedatei -Encoding Utf8

Write-Host "HTML-Dokument wurde in '$ausgabedatei' gespeichert."
