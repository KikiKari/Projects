...
<#
.SYNOPSIS
Generates an HTML document similar to language.html and writes it to a specified file.

.DESCRIPTION
This PowerShell script generates an HTML document that mimics the structure and content of language.html.
It accepts a single parameter for the output file path.

.PARAMETER OutputPath
The path to the file where the generated HTML will be written.

.EXAMPLE
.\Generate-LanguageHtml.ps1 -OutputPath "C:\temp\language.html"
#>
        ...
        <div id="main-col-inner">
            <section class="raku page-header">
                <div class="container px-4">
                    <div class="raku page-title has-text-centered">404</div>
                    <div class="raku page-subtitle has-text-centered"></div>
                </div>
            </section>
            <section class="raku page-content">
                <div class="container px-4">
                    <div class="columns one-col">
                        <img src="/assets/images/Camelia-404.png" class="camelia">
                        <h2 id="404:_Page_Not_Found" class="raku-h2">
                            <a href="#404" title="go to top of document">404: Page Not Found
                                <a class="raku-anchor" title="direct link" href="#404:_Page_Not_Found">§</a>
                            </a>
                        </h2>
                        <p>We're sorry, but the content you tried to reach wasn't found.</p>
                        <p>While we do review server logs to catch these issues, we recently deployed a new version of the site, so please feel free to <a href="https://github.com/Raku/doc-website/issues/">report any issues</a>.</p>
                        <p>Thanks!</p>
                    </div>
                </div>
            </section>
...
Write-Host "HTML document generated and written to $OutputPath"
