#!/usr/bin/env pwsh
# 1781743218784_0e4dc0_7e7141.tcl — portiert nach powershell
# Quelle: tcl, Projects@abstractions:tcl/1781743218784_0e4dc0_7e7141.tcl
...
function Main {
    ...
    Set-Content -Path $outputFile -Value $htmlContent.Trim()
