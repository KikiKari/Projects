...
porting the functionality from the original HTML/JavaScript implementation to PowerShell 7.
...
.EXAMPLE
.\Generate-3DVisualization.ps1 -OutputPath "C:\temp\3d.html"
#>
...
# Define the HTML content as a here-string
$htmlContent = @'
<!DOCTYPE html>
<html lang="de">
<head>
