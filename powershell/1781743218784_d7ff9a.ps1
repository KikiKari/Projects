...
# In PowerShell gibt es kein direktes Äquivalent zu Tcl's package require
# Daher wird der Code so portiert, wie es die PowerShell-Syntax erlaubt
...
# In PowerShell gibt es keine direkte Entsprechung für Tcl's main-Block
# Daher wird die Funktion generateHTML aufgerufen, wenn das Skript ausgeführt wird
generateHTML
