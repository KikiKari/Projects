...
.DESCRIPTION
    ...
    application. The application allows users to create, open, edit, and encrypt/decrypt
    secret vaults using client-side encryption (AES-256-GCM + PBKDF2).
.PARAMETER OutputFile
    The path where the generated HTML file will be saved.
.EXAMPLE
    .\Generate-SecretVault.ps1 -OutputFile "secret-vault.html"
#>
