#!/usr/bin/env pwsh
# 1781743218784_762dc8.sh — portiert nach powershell
# Quelle: shell, Projects@abstractions:shell/1781743218784_762dc8.sh
# Erzeugt: 2026-08-18 durch ABSTRACTIONS_MANAGER.py

<#
.SYNOPSIS
    Generates an HTML file for the Secret-Vault Public Tool.
.DESCRIPTION
...
# Artifact metadata as JSON string
$artifactMeta = @{
...
# HTML template with embedded styles and JavaScript
$htmlContent = @"
<!DOCTYPE html>
