#!/usr/bin/env pwsh
# 1781743218784_0e4dc0_7e7141.py — portiert nach powershell
# Quelle: python, Projects@abstractions:python/1781743218784_0e4dc0_7e7141.py
...
function Main {
    ...
    Generate-Html | Out-File -FilePath $outputFile -Encoding UTF8
