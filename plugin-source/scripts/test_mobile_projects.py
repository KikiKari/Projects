...
require("forMainFrameOnly: true" in ios_webview and "securityOrigin.host == \"www.tiktok.com\"" in ios_webview, "origin-restricted iOS bridge")
...
print("PASS: iOS/Android versions, bridge boundaries, cleartext policy, schema, source sync and secret exclusions")
