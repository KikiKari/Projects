...
def main():
    parser = argparse.ArgumentParser(
        description='Generates the 3D visualization HTML file for Secret-Vault Public.',
        epilog='This script creates an interactive 3D architectural visualization of the Secret-Vault system, porting the functionality from the original HTML/JavaScript implementation to Python 3.12. The output is written to a specified file path.'
    )
    parser.add_argument('output_path', help='The file path where the generated HTML will be saved')
...
'''
    ...
    print(f"HTML file generated successfully at: {args.output_path}")
