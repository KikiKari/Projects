#!/usr/bin/env python3
# 3d_111adf.tcl — portiert nach python
...
try:
    ...
    print("Error generating HTML: {}".format(error), file=sys.stderr)
    sys.exit(1)
...
try:
    ...
    print("Error writing to file '{}': {}".format(output_file, error), file=sys.stderr)
    sys.exit(1)
