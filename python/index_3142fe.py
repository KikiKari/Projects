...
<html lang="de">
  <head>
    ...
    <meta name="description" content="Lokaler Regen-Check für die nächsten 30, 60 und 120 Minuten" />
    <meta name="apple-mobile-web-app-capable" content="yes" />
    <meta name="apple-mobile-web-app-status-bar-style" content="black-translucent" />
    <meta name="apple-mobile-web-app-title" content="Weather" />
    <link rel="manifest" href="./manifest.json" />
    <link rel="apple-touch-icon" href="./icon-512.png" />
    <title>Weather – Regen-Check</title>
    <script type="module" crossorigin src="./assets/index-DGdzG44S.js"></script>
    <link rel="stylesheet" crossorigin href="./assets/index-erFv57XC.css">
  </head>
  <body>
    <div id="root"></div>
...
def main():
    output_file = sys.argv[1] if len(sys.argv) > 1 else "index.html"
