#!/usr/bin/env python3
# 1781743218784_260531_61d8aa.tcl — portiert nach python
# Quelle: tcl, Projects@abstractions:tcl/1781743218784_260531_61d8aa.tcl
...
if len(sys.argv) != 2:
    print("Usage: {} output_file.html".format(sys.argv[0]), file=sys.stderr)
    sys.exit(1)
