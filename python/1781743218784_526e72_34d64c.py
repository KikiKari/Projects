#!/usr/bin/env python3
# 1781743218784_526e72.sh — portiert nach python
# Quelle: shell, Projects@abstractions:shell/1781743218784_526e72.sh
...
def main():
    ...
    if len(sys.argv) != 2:
        print("Usage: {} <output_path>".format(sys.argv[0]), file=sys.stderr)
        sys.exit(1)

    output_path = sys.argv[1]

    # HTML-Inhalt (gleich wie im Shell-Skript)
