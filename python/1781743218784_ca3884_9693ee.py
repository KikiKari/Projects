#!/usr/bin/env python3
# 1781743218784_ca3884.tcl — portiert nach python
# Quelle: tcl, Projects@abstractions:tcl/1781743218784_ca3884.tcl
...
# Schreiben des HTML-Inhalts in die angegebene Datei
try:
    with open(output_file, 'w', encoding='utf-8') as fh:
        fh.write(html_content)
except Exception as e:
    print("Could not open file '{}' for writing: {}".format(output_file, str(e)), file=sys.stderr)
    sys.exit(1)
