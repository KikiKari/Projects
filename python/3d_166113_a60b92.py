#!/usr/bin/env python3
# 3d_166113.pl — portiert nach python
# Quelle: perl5, Projects@abstractions:perl5/3d_166113.pl
# Erzeugt: 2026-08-08 durch ABSTRACTIONS_MANAGER.py

# 3d.html — portiert nach python3
...
json_spec = json.dumps(SPEC, ensure_ascii=False)

# HTML-Datei generieren
html_content = html_template % json_spec

# In Datei schreiben
try:
    with open(ausgabe_datei, 'w', encoding='utf-8') as fh:
        fh.write(html_content)
except IOError as e:
    print("Kann Datei '{}' nicht öffnen: {}".format(ausgabe_datei, e))
    sys.exit(1)

print("HTML-Datei wurde erfolgreich erstellt: {}".format(ausgabe_datei))
