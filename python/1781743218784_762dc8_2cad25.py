#!/usr/bin/env python3
# 1781743218784_762dc8.ps1 — portiert nach python
...
def main():
    parser = argparse.ArgumentParser(description='Generiert die HTML-Datei für das Secret-Vault Public Tool.')
    parser.add_argument('output_file', help='Der Pfad zur zu erstellenden HTML-Ausgabedatei.')
    
    args = parser.parse_args()
    generate_html(args.output_file)
