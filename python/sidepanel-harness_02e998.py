...
def generate_html():
    state_json = json.dumps(generate_state(), ensure_ascii=False)
...
def main():
    output_file = sys.argv[1] if len(sys.argv) > 1 else "sidepanel-harness.html"
