#!/usr/bin/env python3
# 3d_053a4a.pl — portiert nach python
...
if len(sys.argv) < 2:
    sys.exit("Verwendung: {} <ausgabedatei>\n".format(sys.argv[0]))

ausgabe_datei = sys.argv[1]

# HTML-Dokument erzeugen
try:
    with open(ausgabe_datei, 'w') as fh:
...
''')
    ...
    sys.exit("Kann Datei '{}' nicht öffnen: {}\n".format(ausgabe_datei, str(e)))
