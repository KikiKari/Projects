#!/usr/bin/env python3
# 1781743218784_0e4dc0_7eee24_06b430.tcl — portiert nach python
# Quelle: tcl, Projects@abstractions:tcl/1781743218784_0e4dc0_7eee24_06b430.tcl
...
const tr=k=>T[k][L];
// apply static i18n
title.textContent=tr("title"); sub.textContent=tr("title"); document.title=tr("title");
