#!/usr/bin/env python3
# 3d_44b946.pl — portiert nach python
...
if len(sys.argv) < 2:
    sys.exit("Bitte gib eine Ausgabedatei als Parameter an.\n")

ausgabedatei = sys.argv[1]
...
# In Datei schreiben
try:
    with open(ausgabedatei, 'w', encoding='utf-8') as fh:
        fh.write(html)
except IOError as e:
    sys.exit(f"Kann {ausgabedatei} nicht öffnen: {e}")

print(f"HTML-Datei wurde erfolgreich in '{ausgabedatei}' gespeichert.")
