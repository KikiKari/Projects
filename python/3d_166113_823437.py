#!/usr/bin/env python3
# 3d_166113.tcl — portiert nach python
...
if len(sys.argv) != 2:
    print("Verwendung: {} <ausgabedatei>".format(sys.argv[0]))
    sys.exit(1)

output_file = sys.argv[1]
write_3d_html(output_file)
print("HTML-Datei wurde erfolgreich erstellt: {}".format(output_file))
