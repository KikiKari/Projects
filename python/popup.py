#!/usr/bin/env python3
# popup.html — portiert nach python
...
def generate_popup_html():
    """Generate the popup.html content as a Python string"""
...
def main():
    """Main function to write HTML content to a file or stdout"""
    if len(sys.argv) > 1:
        filename = sys.argv[1]
        with open(filename, 'w', encoding='utf-8') as f:
            f.write(generate_popup_html())
    else:
        print(generate_popup_html())
