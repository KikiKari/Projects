...
"""
Generates the 3D interactive architecture visualization HTML file.
"""
...
<title>tt-live — Interaktive Architektur</title>
<meta name="description" content="Vom @handle zum Ereignis: Auflösung, Prüfung, Daemon — drehen, zoomen, Knoten auswählen.">
...
<div class="wrap">
  ...
  <h1>tt-live</h1>
  <p class="lede">Vom @handle zum Ereignis: Auflösung, Prüfung, Daemon — drehen, zoomen, Knoten auswählen.</p>
...
def main():
    """Main function to write the HTML to a file."""
    if len(sys.argv) != 2:
    ...
    try:
        ...
        print("HTML file generated successfully: {}".format(output_file))
    except Exception as e:
        print("Error generating HTML file: {}".format(str(e)))
        sys.exit(1)
