...
Bindet ausschließlich an Loopback. Die Erweiterung akzeptiert nur `127.0.0.1` oder `localhost`. Zugriff erfordert den beim Setup ausgegebenen Pairing-Code.
...
| Inhalt | Ort |
|---|---|
| Dienstadresse, Pairing-Code | `chrome.storage.local` |
