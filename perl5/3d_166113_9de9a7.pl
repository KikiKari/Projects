#!/usr/bin/env perl
# 3d_166113.ps1 — portiert nach perl5
...
my $output_file = "3d.html";
GetOptions("output-file=s" => \$output_file) or die "Error in command line arguments\n";
...
print "3D visualization saved to $output_file\n";
