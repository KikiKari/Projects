#!/usr/bin/env perl
# language.html — portiert nach perl5
...
# Function to generate the 404 page HTML
sub generate_404_page {
    my $html = <<'EOF';
<!DOCTYPE html>
...
# Main execution
sub main {
    my $output_file = $ARGV[0] || 'language.html';
    
    open my $fh, '>', $output_file or die "Cannot open $output_file for writing: $!";
    print $fh generate_404_page();
    close $fh;
    
    print "404 page generated successfully as $output_file\n";
}
