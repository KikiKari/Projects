#!/usr/bin/env perl
# 1781743218784_762dc8.ps1 — portiert nach perl5
...
1781743218784_762dc8.pl - Generiert die HTML-Datei für das Secret-Vault Public Tool
...
HTML_END
    ...
    $html_content .= to_json($artifact_meta, { pretty => 1, utf8 => 1 }) . "\n";
