#!/usr/bin/env perl
# 3d_053a4a.ps1 — portiert nach perl5
...
my $output_path = $ARGV[0] // die "Usage: $0 <output_path>\n";

my $html_template = <<'HTML_END';
<!DOCTYPE html>
<html lang="de">
<head>
<meta charset="utf-8">
...
print "HTML-Datei wurde erfolgreich erstellt: $output_path\n";
