#!/usr/bin/env perl
# 1781743218784_0e4dc0_7e7141.ps1 — portiert nach perl5
# Quelle: powershell, Projects@abstractions:powershell/1781743218784_0e4dc0_7e7141.ps1
...
=item * OutputFile - The path to the output HTML file.

=back

=head1 EXAMPLE

    perl script.pl --outputfile "vault.html"

=cut

my $OutputFile;
GetOptions('outputfile=s' => \$OutputFile) or die "Ungültige Optionen\n";

die "Bitte geben Sie eine Ausgabedatei an.\n" unless defined $OutputFile;
