#!/usr/bin/perl
# 1781743218784_0e4dc0_7eee24.sh — portiert nach perl5
...
if (@ARGV != 1) {
    print STDERR "Aufruf: $0 <Ausgabedatei>\n";
    exit 1;
}
...
open(my $fh, '>', $outputFile) or die "Kann Datei '$outputFile' nicht öffnen: $!";
print $fh <<'EOF';
<!DOCTYPE html>
...
print "HTML-Datei erzeugt: $outputFile\n";
