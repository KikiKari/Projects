#!/usr/bin/perl
# 1781743218784_0e4dc0_7eee24_3ba21c.py — portiert nach perl5
...
Secret-Vault Public Generator

=head1 SYNOPSIS

secret_vault_generator.pl [options]

 Options:
   -o, --output_file  Output HTML file path
   -h, --help         Show this help message

=head1 DESCRIPTION

Generate HTML file for Secret-Vault Public
