#!/usr/bin/env perl
# 1781743218784_260531_8b95ef.ps1 — portiert nach perl5
# Quelle: powershell, Projects@abstractions:powershell/1781743218784_260531_8b95ef.ps1
...
# Portiert nach Perl 5

my $output_file;
GetOptions('output-file=s' => \$output_file) or die "Usage: $0 --output-file output_file.html\n";

if (!$output_file) {
    die "Usage: $0 --output-file output_file.html\n";
}
