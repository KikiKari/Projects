#!/usr/bin/env perl
# 3d_166113.tcl — portiert nach perl5
...
# Hauptprogramm
if (@ARGV != 1) {
    print "Verwendung: $0 <ausgabedatei>\n";
    exit 1;
}
