#!/usr/bin/env perl
# 1781743218784_260531.tcl — portiert nach perl5
...
# 1781743218784_260531.tcl — portiert nach Perl 5
# Quelle: tcl, Projects@abstractions:tcl/1781743218784_260531.tcl
...
# Perl script to generate the Secret Vault Public HTML file
# Usage: perl this_script.pl output_file.html

if (@ARGV != 1) {
    print "Usage: perl " . ($0 =~ /([^\/\\]+)$/)[0] . " output_file.html\n";
    exit 1;
}

my $outputFile = $ARGV[0];
open(my $fd, '>', $outputFile) or die "Could not open file '$outputFile' $!";
