#!/usr/bin/perl
# 3d_166113.sh — portiert nach perl5
...
if (@ARGV != 1) {
  print STDERR "Aufruf: $0 <ausgabedatei.html>\n";
  exit 1;
}
my $ausgabe = $ARGV[0];

# Erzeuge die HTML-Datei
open my $fh, '>', $ausgabe or die "Kann Datei '$ausgabe' nicht öffnen: $!";
...
print STDERR "HTML-Datei wurde erfolgreich erstellt: $ausgabe\n";
