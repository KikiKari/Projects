#!/usr/bin/env perl
# 3d_111adf.ps1 — portiert nach perl5
# Quelle: powershell, Projects@abstractions:powershell/3d_111adf.ps1
...
my $output_path = shift @ARGV or die "Usage: $0 OUTPUT_PATH\n";
...
print "HTML file created at: $output_path\n";
