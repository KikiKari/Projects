...
function DownloadBand({ lang }: { lang: Language }) {
  const de = lang === "de";
  return <section className="download-band"><h2>Version 0.7.1</h2><a className="button primary" href="/downloads/tiktok-live-companion-extension-0.7.1.zip" download><Icon name="download"/>{de ? "Erweiterung ZIP" : "Extension ZIP"}</a><a className="button secondary" href="/downloads/tiktok-live-companion-plugin-0.7.1.zip" download><Icon name="link"/>{de ? "Codex-Plugin ZIP" : "Codex plugin ZIP"}</a><a className="button secondary" href="/downloads/tiktok-live-companion-service-0.7.1.zip" download><Icon name="sound"/>{de ? "Windows-Dienst ZIP" : "Windows service ZIP"}</a><a className="button secondary" href="/downloads/tiktok-live-companion-ios-0.7.1-source.zip" download><Icon name="monitor"/>{de ? "iOS-Quellprojekt" : "iOS source project"}</a><a className="button secondary" href="/downloads/tiktok-live-companion-android-0.7.1-source.zip" download><Icon name="monitor"/>{de ? "Android-/HyperOS-Quelle" : "Android/HyperOS source"}</a><a className="button secondary" href="/downloads/tiktok-live-companion-0.7.1-SHA256.txt" download><Icon name="info"/>{de ? "SHA-256 prüfen" : "Verify SHA-256"}</a></section>;
}

function Downloads({ lang }: { lang: Language }) {
  const de = lang === "de";
  const [copied, setCopied] = useState(false);
  const hashes = "83c672046a90e7cfa1c1bf5d02c4db09be0ada9cfcd6ebd39b632703c4b8a97e  tiktok-live-companion-extension-0.7.1.zip\ne99ae3ecbc74ca7b0864d4002691624e560ef20304369107ef5d132e17874519  tiktok-live-companion-plugin-0.7.1.zip\n8a7fce8bbdb017ce1ccfbbacfcc31e0185389cda45d9ebb76344f8bec8569244  tiktok-live-companion-service-0.7.1.zip\n8a3049d6977bd0db0576d45f8dfb187145df75a4863d1e5fd1034ec6bba76dcf  tiktok-live-companion-ios-0.7.1-source.zip\n90f787cc58507f871dd37601cee412c034472f01d9ddd5186d3c0a616a705880  tiktok-live-companion-android-0.7.1-source.zip\n38ad0bb204f945ba0be816e86150197c9375afb1c06fefd921ae90c3abbea3e2  tiktok-live-companion-android-0.7.1.apk";
  return <PageIntro title={de ? "Downloads und Release 0.7.1" : "Downloads and release 0.7.1"} lead={de ? "Browser-, Dienst- und Mobile-Quellartefakte mit nachvollziehbaren Integritätswerten." : "Browser, service, and mobile-source artifacts with verifiable integrity values."}><DownloadBand lang={lang}/><div className="hash-block"><div><h2>SHA-256</h2><button onClick={async () => { await navigator.clipboard?.writeText(hashes); setCopied(true); }}>{copied ? (de ? "Kopiert" : "Copied") : (de ? "Prüfsummen kopieren" : "Copy checksums")}</button></div><pre>{hashes}</pre></div><section className="release-notes"><h2>{de ? "Änderungen" : "What's new"}</h2><p>{de ? "Version 0.7.1 ergänzt native SwiftUI- und Compose-Projekte, eine origin-beschränkte Mobile-WebView-Bridge und einen kurzlebigen ShazamKit-Token-Endpunkt. Die Browser-Erweiterung behält AudD; iOS und Android/HyperOS verwenden ShazamKit mit Mikrofon-Fallback." : "Version 0.7.1 adds native SwiftUI and Compose projects, an origin-restricted mobile WebView bridge, and a short-lived ShazamKit token endpoint. The browser extension keeps AudD; iOS and Android/HyperOS use ShazamKit with microphone fallback."}</p></section></PageIntro>;
}
