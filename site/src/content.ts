...
export const strings = {
  de: {
    ...
    download: "Version 0.8.0 herunterladen", install: "Installation öffnen", compatibility: "Edge & Chrome · Manifest V3 · optionaler lokaler Windows-Dienst",
  ...
  en: {
    ...
    download: "Download version 0.8.0", install: "Open installation", compatibility: "Edge & Chrome · Manifest V3 · optional local Windows service",
...
export const searchText: Record<Language, Record<PageKey, string>> = {
  de: {
    ...
    downloads: "Downloads Browser-Erweiterung 0.8.0 Release ZIP SHA-256 Prüfsumme"
  },
  en: {
    ...
    downloads: "Downloads browser extension 0.8.0 release ZIP SHA-256 checksum"
  }
};
