#!/bin/bash
# 3d_053a4a.ps1 — portiert nach shell
...
if [[ $# -ne 1 ]]; then
    echo "Fehler: OutputPath Parameter erforderlich"
    exit 1
fi

OUTPUT_PATH="$1"

# HTML-Template als Here-Document
cat > "$OUTPUT_PATH" << 'EOF'
<!DOCTYPE html>
<html lang="de">
<head>
...
echo "HTML-Datei wurde erfolgreich erstellt: $OUTPUT_PATH"
