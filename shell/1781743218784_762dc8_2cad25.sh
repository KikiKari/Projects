...
generate_html() {
    ...
    # Create artifact meta JSON manually since we can't use PowerShell's ConvertTo-Json
    local artifact_meta='{
...
EOF
    ...
    echo "HTML-Datei erfolgreich generiert: $outputFile"
}
