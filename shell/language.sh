#!/bin/bash
# language.html — portiert nach shell
...
# This script generates the language.html file
# Usage: ./script.sh <output-file>

output_file="${1:-language.html}"
    ...
    <div id="options-search-info" class="modal">
        ...
        <button class="modal-close is-large" aria-label="close"></button>
         ...
         <div id="download-ebook" class="modal">
                    ...
                    <div class="modal-content">
                        <div class="box">
                            <p><a href="/RakuDocumentation.epub" download>RakuDocumentation.epp</a> is a work in
