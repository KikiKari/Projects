...
# Dieses Skript erzeugt eine HTML-Datei mit dem Inhalt der ursprünglichen index.html
# Es nimmt einen Parameter entgegen, in den die erzeugte HTML-Datei geschrieben wird
