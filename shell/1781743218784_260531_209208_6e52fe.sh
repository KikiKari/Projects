#!/usr/bin/env bash
# 1781743218784_260531_209208.tcl — portiert nach shell
# Quelle: tcl, Projects@abstractions:tcl/1781743218784_260531_209208.tcl
...
if [[ $# -ne 1 ]]; then
    echo "Usage: $(basename "$0") output_file.html" >&2
    exit 1
fi
