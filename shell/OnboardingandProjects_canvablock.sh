#!/bin/bash
# OnboardingandProjects_canvablock.html — portiert nach shell
# Quelle: html, Onboarding@main:docs/appendix/claude-cowork/OnboardingandProjects_canvablock.html
# Erzeugt: 2026-08-19 durch ABSTRACTIONS_MANAGER.py

set -euo pipefail

# Generates OnboardingandProjects_canvablock.html to specified output file
# Usage: ./generate_html.sh output.html
