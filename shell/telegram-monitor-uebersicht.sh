...
# telegram-monitor-uebersicht.sh - Erzeugt eine HTML-Datei fuer die Telegram-Monitor-Uebersicht
# Aufruf: ./telegram-monitor-uebersicht.sh <ausgabedatei>

# Pruefe Kommandozeilenargument
if [[ $# -ne 1 ]]; then
