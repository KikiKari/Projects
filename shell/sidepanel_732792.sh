...
# Portierung des HTML-Dokuments sidepanel.html nach Bash 5
# Erzeugt das HTML-Dokument und schreibt es in eine Datei

# Funktion zur Erstellung des HTML-Dokuments
create_html() {
    cat << 'EOF'
<!doctype html>
<html lang="de">
...
# Hauptprogramm
main() {
    local output_file="${1:-sidepanel.html}"
    
    # Erstelle das HTML-Dokument und schreibe es in die Ausgabedatei
